...
//
    ...
    private static void createSpellCards(ArrayList<SpellCard> spellCards, ArrayList<Buff> buffs) {
        ...
        SpellCard empower = new SpellCard(203, "Empower", 250, 1, buffs, target);
        ...
        SpellCard fireBall = new SpellCard(204, "Fire Ball", 400, 1, buffs, target);
        ...
        SpellCard godStrength = new SpellCard(205, "God Strength", 450, 2, buffs, target);
        spellCards.add(godStrength);

        buffs = new ArrayList<>();
        buffs.add(new FireBuff(Kind.NEGATIVE, 2, false, 2));
        target = new Target(Type.AREA, 2, null);
        SpellCard hellFire = new SpellCard(206, "Hell Fire", 600, 3, buffs, target);
        ...
        SpellCard lightingBolt = new SpellCard(207, "Lighting Bolt", 1250, 2, buffs, target);
        spellCards.add(lightingBolt);

        buffs = new ArrayList<>();
        buffs.add(new PoisonBuff(Kind.NEGATIVE, 1, false, 1));
        target = new Target(Type.AREA, 3, null);
        SpellCard poisonLake = new SpellCard(208, "Poison Lake", 900, 5, buffs, target);
        ...
        target = new Target(Type.SOLDIER, 0, SoldierTargetType.ONE_FRIENDLY_SOLDIER);
        SpellCard madness = new SpellCard(209, "Madness", 650, 0, buffs, target);
        ...
        SpellCard allDisarm = new SpellCard(210, "All Disarm", 2000, 9, buffs, target);
        spellCards.add(allDisarm);

        buffs = new ArrayList<>();
        buffs.add(new PoisonBuff(Kind.NEGATIVE, 4, false, 1));
        target = new Target(Type.SOLDIER, 0, SoldierTargetType.ALL_ENEMIES);
        SpellCard allPoison = new SpellCard(211, "All Poison", 1500, 8, buffs, target);
        ...
        SpellCard dispel = new SpellCard(212, "Dispel", 2100, 0, buffs, target);
        ...
        target = new Target(Type.SOLDIER, 0, SoldierTargetType.ONE_FRIENDLY_SOLDIER);
        SpellCard healthWithProfit = new SpellCard(213, "Health with profit", 2250, 0, buffs, target);
        spellCards.add(hellFire);

        buffs = new ArrayList<>();
        buffs.add(new PowerBuff(Kind.POSITIVE, 1, false, 0, 6));
        target = new Target(Type.SOLDIER, 0, SoldierTargetType.ONE_FRIENDLY_SOLDIER);
        SpellCard powerUp = new SpellCard(214, "Power Up", 2500, 2, buffs, target);
        ...
        SpellCard allPower = new SpellCard(215, "All Power", 2000, 4, buffs, target);
        ...
        SpellCard allAttack = new SpellCard(216, "All Attack", 1500, 4, buffs, target);
        ...
        SpellCard weakening = new SpellCard(217, "Weakening", 1000, 1, buffs, target);
        ...
        SpellCard sacrifice = new SpellCard(218, "Sacrifice", 1600, 2, buffs, target);
        spellCards.add(sacrifice);

        buffs = new ArrayList<>();
        buffs.add(new KillBuff(Kind.NEGATIVE, 1, false));
        target = new Target(Type.SOLDIER, 0, SoldierTargetType.FRIENDLY_HERO);
        SpellCard kingsGuard = new SpellCard(219, "Kings Guard", 1750, 9, buffs, target);
        spellCards.add(kingsGuard);

        buffs = new ArrayList<>();
        buffs.add(new StunBuff(Kind.NEGATIVE, 2, false));
        target = new Target(Type.SOLDIER, 0, SoldierTargetType.ONE_ENEMY);
        SpellCard shock = new SpellCard(220, "Shock", 1200, 1, buffs, target);
